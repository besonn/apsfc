							...
							<div id="menu">
								...
								<div id="mainmenu">
									<ul>
										...
										<li><a href="${pageContext.request.contextPath }/qiantai/shoppingcar.jsp" target="_self">我的餐车</a></li>

										<li><a href="${pageContext.request.contextPath }/qiantai/order.jsp" target="_self">我的订单</a></li>
										<li><a href="${pageContext.request.contextPath }/qiantai/center.jsp" target="_self">用户中心</a></li>
