...
function send1()
{
document.form1.action="../UsersOrderServlet?action=searchmyname&curpage=1";
document.form1.submit();
}
function send2()
{
document.form1.action="../UsersOrderServlet?action=searchmydate&curpage=1";
document.form1.submit();
}
</script>
										...
										<tbody style="margin: 0; padding: 0">
											...
											<tr>
												...
												<td class="line_table" align="left" width="60%"><input
													...
													value="查询" onclick="send2()"></td>
											</tr>
											<tr>
												<td class="line_table" align="center" colspan="3"><a
													href="${pageContext.request.contextPath}/UsersOrderServlet?action=searchmyall">我的所有订单</a>&nbsp;&nbsp;&nbsp;&nbsp; <a href="${pageContext.request.contextPath}/UsersOrderServlet?action=searchmyde&de=false">未已派送订单</a>&nbsp;&nbsp;&nbsp;&nbsp;
													<a href="${pageContext.request.contextPath}/UsersOrderServlet?action=searchmyde&de=true">已派送订单</a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
											</tr>
									</table>
								</form>
							</div>
