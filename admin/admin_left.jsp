    ...
    <td width="182" valign="top"><div id="container">
      ...
      <div class="content">
        ...
        <ul class="MM">
            ...
            <li><a href="${pageContext.request.contextPath }/TypesServlet?action=findtypes&curpage=1" target="main">类别信息列表</a></li>
        </ul>
      </div>
      ...
      <div class="content">
        ...
        <ul class="MM">
		   <li><a href="../admin/notice_add.jsp" target="main">添加新通告</a></li>
            <li><a href="${pageContext.request.contextPath }/NoticeServlet?action=findnotice&curpage=1" target="main">通告信息列表</a></li>
        </ul>
      </div>
      ...
      <div class="content">
        ...
        <ul class="MM">
          <li><a href="${pageContext.request.contextPath }/OrdersServlet?action=findorders&curpage=1" target="main">销售订单信息列表</a></li>
          <li><a href="../admin/order_search.jsp" target="main">销售订单查询</a></li>
          <li><a href="${pageContext.request.contextPath }/OrdersServlet?action=findtoday" target="main">本日销售额统计</a></li>
        </ul>
      </div>
    </div>
